...
const array = ['acho','Velluveli','udayp','tutu','Thug','suhurth','Single boy','Settak','sena','Sed','sed life','sed bgm','Sarasu','Role','Reyali','Poyalo','power varate','Power an','Pottikum','poli','Podamyr','pm vada','Pabam','onu poda chekka','oh','O','number pottikum','no love','nerth','Nenak nan und','ne power an','ne etha','nanban fake','nan und','MPL','Monuse','money hist bgm','mone','Mandan','Machane','lshta','Love','Love you','Love me','line','line undo','Ketto','karale','Kane','kalikuno','kalikkan nekkale','Kalikkale','joker','Inna pedicho','i love u','I love you baby','aliya','ano','arakkal tharavad','arakkal','Aran ariyo','ariyo','arulla','ayn','Ayo','AyoAyo','Badboy','Bgm ettutharam','Bgm ille','BGM poratte','Bgm','Da','Hi','hlo','kannapi','kollamo','kollum nan','myr','ok','polichille','poda','ramana','sad','sorry','tharilla','Boss ethi','Bosse','chalakallada','Chank uyr','Chank','chankan','Chettan oru bgm ettu tharate','coming','Don','Dream','gays','ennalum','Entry','ennit','Group','Groupel','1','2','aara','Aarulle','adi','power','set','photo','ok','umbi','help','good morning','pewer','Hlo','Ayn','poli','Onn poda','Number','Sed','entha','Sorry','Done','Pani pali','Aarum ille','arum ille','again','Ne ara','Hi','pinnallah',Shamil','alive','Bgm','friend aako','muthe','chaya kudicho','poda','bot uyir','Bot','bot','no','Hello','mm','song','shamile','shamil poli','onnu poda chekka','nirthi poda']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
    ...
    Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {   
        ...
        let banned = jid.find( Jid => Jid === message.jid);
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '919744097895@s.whatsapp.net') {
